...
const NAME_OF_BUCKET = "socialq--dev"; // <-- Use your bucket name here
...
const retrievePrivateFile = (key) => { // probably don't need for this project
    let fileUrl;
    if (key) {
...
const storage = multer.memoryStorage({
  ...
  const singleMulterUpload = (nameOfKey) => //nameOfKey must match the name under which you stored the data on the frontend.
